class Ninjadex {
    ...
    async loadMonsters() {
        ...
        try {
            const response = await fetch(window.getAssetPath('data/json/monsters_database.json'));
    ...
    async loadEquipments() {
        ...
        try {
            const response = await fetch(window.getAssetPath('data/json/structured_equipment_data.json'));
            const data = await response.json();
            this.equipments = [];
    ...
    async loadItems() {
        ...
        try {
            const response = await fetch(window.getAssetPath('data/json/items.json'));
            const data = await response.json();
            this.items = data;
    ...
    async loadSkillsets() {
        ...
        try {
            const response = await fetch(window.getAssetPath('data/json/structured_skillsets.json'));
            const data = await response.json();
            this.skillsets = [];
